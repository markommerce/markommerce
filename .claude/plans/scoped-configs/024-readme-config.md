...
- [ ] `it disambiguates the package from marko/config in the first paragraph`
- [ ] `it shows a complete minimal usage example with declaration, registration, and resolved read`
- [ ] `it documents the four CLI commands with one-line descriptions and example invocations`
- [ ] `it points to the docs site for full reference`
- [ ] `it lists the required driver package (markommerce/config-pgsql) under installation`
