    ...
    slots: [
        'content' => [
            new Place(
                ...
                name: 'catalog.product_grid_fragment',
                props: [
                    ...
                    'products' => Slot::repeat(
                        ...
                        children: [
                            new Place(
                                ...
                                name: 'catalog.product_card_fragment',
                                props: ['product' => Source::iterated(ProductIteration::class)],
                                slots: [
                                    'badges' => [
                                        new Place(
                                            component: StockBadge::class,
                                            name: 'catalog.product_card_fragment.stock_badge',
                ...
                template: 'catalog-storefront::components/product-grid-fragment',
            ),
        ],
    ],
);
