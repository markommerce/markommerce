...
function catalogFragmentMakeSortRegistry(): CategorySortOrderRegistry
{
...
{
    return new PaginationOptionsResolver(catalogFragmentMakeConfigResolver(['maxPageDepth' => $maxPageDepth]), catalogFragmentMakeSortRegistry());
}
