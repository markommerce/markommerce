...
namespace Markommerce\Attribute\Tests\Support;
...
class FakeAttributeDefinitionRepository implements AttributeDefinitionRepositoryInterface
{
    ...
    public function delete(Entity $entity): void
    {
        ...
        if ($entity->id !== null) {
            // Cascade-delete options (mimicking FK ON DELETE CASCADE)
            $this->options = array_values(array_filter(
                $this->options,
                fn (AttributeOption $o) => $o->attributeId !== $entity->id,
            ));
