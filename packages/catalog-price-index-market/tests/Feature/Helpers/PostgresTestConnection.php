...
namespace Markommerce\CatalogPriceIndexMarket\Tests\Feature\Helpers;
...
class PostgresTestConnection extends PgSqlConnection
{
    ...
    public function __construct()
    {
        ...
        parent::__construct(config: self::buildDummyConfig());
    }
    ...
    protected function createPdo(
        ...
        return new PDO($testDsn, $this->envUsername, $this->envPassword, $options);
    }
    ...
    private static function buildDummyConfig(): DatabaseConfig
    {
        ...
        $tmpDir = sys_get_temp_dir() . '/marko-test-db-config-price-index-market-' . getmypid();
