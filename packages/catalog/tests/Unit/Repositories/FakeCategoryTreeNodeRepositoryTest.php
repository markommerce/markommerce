...
it('interface declares the five custom methods (findByTree, findChildren, findRoots, findByCategoryInTree, findByCategoryAcrossTrees)', function (): void {
    $reflection = new ReflectionClass(CategoryTreeNodeRepositoryInterface::class);
...
it('fake findByCategoryInTree returns all placements of a category within a tree (multi-placement)', function (): void {
    $repository = new FakeCategoryTreeNodeRepository();
