...
it(
    'CategoryTreeMarketAssignmentRepository lives in Markommerce\\CatalogMarket\\Repositories namespace and preserves the INSERT … ON CONFLICT upsert behaviour in save()',
    function (): void {
