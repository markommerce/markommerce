...
it(
    'CategoryTreeMarketAssignmentService::assignTreeToMarket stores the assignment for an unknown market',
    function (): void {
...
it(
    'CategoryTreeMarketAssignmentService::assignTreeToMarket replaces an existing assignment for the same market',
    function (): void {
        $treeRepo = new FakeCategoryTreeRepository();
        $assignmentRepo = new FakeCategoryTreeMarketAssignmentRepository();
...
it(
    'CategoryTreeMarketAssignmentService::assignTreeToMarket throws CategoryTreeNotFoundException when the tree id is unknown',
    function (): void {
        $service = makeCategoryTreeMarketAssignmentServiceForCatalogMarket();
...
it(
    'CategoryTreeMarketAssignmentService::unassignMarket removes the assignment for the given market',
    function (): void {
        $treeRepo = new FakeCategoryTreeRepository();
        $assignmentRepo = new FakeCategoryTreeMarketAssignmentRepository();
...
it(
    'CategoryTreeMarketAssignmentService::unassignMarket is a no-op when no assignment exists for the market',
    function (): void {
        $assignmentRepo = new FakeCategoryTreeMarketAssignmentRepository();
