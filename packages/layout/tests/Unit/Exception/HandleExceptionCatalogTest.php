...
it('throws DefaultHandleConflictException when a default handle declares an extends or inherits chain', function (): void {
...
it('throws UnknownDynamicHandleException when a HandleProvider returns a handle key not in the artifact', function (): void {
...
it('throws DuplicateContextTokenException when an inherits or default merge introduces a duplicate token', function (): void {
...
it('throws ChainedHandleProviderException when a dynamic handle\'s tree itself declares handleProviders', function (): void {
