...
class Source
{
    ...
    public static function route(string $name, string $as = 'string'): RouteSource
    {
    ...
    public static function query(string $name, mixed $default = null, string $as = 'string'): QuerySource
    {
        self::assertValidCast($as);
    ...
    public static function context(string $token, ?string $path = null): ContextSource
    {
        return new ContextSource($token, $path);
    }

    public static function iterated(string $token, ?string $path = null): IteratedSource
    {
        return new IteratedSource($token, $path);
    }

    public static function parentData(string $key, string $as = 'string'): ParentDataSource
    {
