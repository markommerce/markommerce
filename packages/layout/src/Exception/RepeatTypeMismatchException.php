...
{
    public static function forItem(string $yieldsType, string $actualItemType): self
    {
        return new self(
    ...
    public static function forItemWithChain(string $yieldsType, string $actualItemType, string $chain): self
    {
        return new self(
            message: "Repeat type mismatch: yields type '$yieldsType' but item is '$actualItemType'.",
