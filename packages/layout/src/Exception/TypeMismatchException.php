...
{
    public static function forProp(string $prop, string $expectedType, string $actualType): self
    {
        return new self(
    ...
    public static function forPropWithChain(string $prop, string $expectedType, string $actualType, string $chain): self
    {
        return new self(
            message: "Type mismatch for prop '$prop': expected '$expectedType', got '$actualType'.",
