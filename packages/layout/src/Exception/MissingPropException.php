...
{
    public static function forProp(string $prop, string $component): self
    {
        return new self(
    ...
    public static function forPropWithChain(string $prop, string $component, string $chain): self
    {
        return new self(
            message: "Required prop '$prop' is missing for component '$component'.",
