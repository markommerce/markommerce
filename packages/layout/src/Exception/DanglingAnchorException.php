...
{
    public static function forAnchor(string $anchor, string $extensionFile): self
    {
        return new self(
    ...
    public static function forAnchorWithChain(string $anchor, string $extensionFile, string $chain): self
    {
        return new self(
