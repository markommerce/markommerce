...
it('creates ConfigKeyConflictException when two definitions claim the same key, naming both classes and the duplicate key', function (): void {
...
it('creates InvalidConfigClassException via factory configClassHasRequiredConstructor when a config class has required constructor params', function (): void {
...
it('creates InvalidConfigClassException via factory propertyMissingDefaultOrNullability when a non-nullable #[Config] property has no default', function (): void {
...
it('creates InvalidConfigClassException via factory nonSubclassPreference when a preferred class is not a subclass of the original', function (): void {
...
it('creates InvalidConfigClassException for properties without #[Config] or with unsupported types (union/intersection/readonly)', function (): void {
...
it('creates InvalidConfigValueException carrying the offending key, raw stored value, and target PHP type', function (): void {
...
it('creates ProxyNotGeneratedException with a config:generate suggestion when a typed proxy is missing at runtime', function (): void {
...
it('creates StaleConfigWriteException naming the key and retry count after optimistic-lock retries are exhausted', function (): void {
...
it('creates AxisNotDeclaredException when a write signature references an axis not declared on the property', function (): void {
...
it('creates SecretCipherException via factory notConfigured naming MARKOMMERCE_CONFIG_SECRET_KEY in the suggestion', function (): void {
...
it('creates SecretCipherException via factory sodiumUnavailable / invalidKeyLength / tamperedCiphertext', function (): void {
...
it('creates ConfigNotFoundException with the missing key in message and a how-to-register suggestion', function (): void {
