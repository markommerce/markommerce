...
it('constructs a ConfigDefinition with key, configClass, field, axes, type, defaultValue, and secret', function (): void {
...
it('exposes ConfigDefinition properties as public read-only via asymmetric visibility or readonly class', function (): void {
    $definition = new ConfigDefinition(
        key: 'markommerce/catalog.grid_page_size',
        configClass: 'App\\Config\\CatalogConfig',
        field: 'gridPageSize',
