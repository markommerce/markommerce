...
it('expands a list of registered classes by adding preference subclasses returned by PreferenceRegistry::getPreference', function (): void {
...
it('throws InvalidConfigClassException when a preferred class is not a subclass of the original config class', function (): void {
    $registry = new PreferenceRegistry();
...
it('propagates PreferenceConflictException::circularPreference unchanged when PreferenceRegistry detects a cycle', function (): void {
    $registry = new PreferenceRegistry();
