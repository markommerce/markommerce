...
namespace Markommerce\CatalogMarketCategoryTrees\Tests\Feature\Helpers;
...
class PostgresTestConnection extends PgSqlConnection
{
    ...
    private static function buildDummyConfig(): DatabaseConfig
    {
        ...
        $tmpDir = sys_get_temp_dir() . '/marko-test-db-config-catalog-market-category-trees-' . getmypid();
