...
it('relocates CategoryTreeMarketAssignmentRepositoryInterface to Markommerce\\CatalogMarketCategoryTrees\\Contracts namespace and preserves its findByMarket and findByTree signatures', function (): void {
    $reflection = new ReflectionClass(CategoryTreeMarketAssignmentRepositoryInterface::class);

    expect($reflection->isInterface())->toBeTrue();
    expect($reflection->getNamespaceName())->toBe('Markommerce\\CatalogMarketCategoryTrees\\Contracts');
