...
function makeCategoryTreeMarketResolver(
...
it('CategoryTreeMarketResolver returns the tree assigned to the given market', function (): void {
    ...
    $resolver = makeCategoryTreeMarketResolver(treeRepo: $treeRepo, assignmentRepo: $assignmentRepo);
...
it('CategoryTreeMarketResolver returns the default tree when no assignment exists for the market', function (): void {
    ...
    $resolver = makeCategoryTreeMarketResolver(treeRepo: $treeRepo);
...
it('CategoryTreeMarketResolver throws DefaultTreeMissingException when neither a market assignment nor a default tree exist', function (): void {
    $resolver = makeCategoryTreeMarketResolver();
