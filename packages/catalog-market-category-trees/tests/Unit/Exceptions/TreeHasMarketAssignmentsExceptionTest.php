...
it('relocates TreeHasMarketAssignmentsException to Markommerce\\CatalogMarketCategoryTrees\\Exceptions namespace with the same forTreeId static factory shape', function (): void {
    $reflection = new ReflectionClass(TreeHasMarketAssignmentsException::class);

    expect($reflection->getNamespaceName())->toBe('Markommerce\\CatalogMarketCategoryTrees\\Exceptions');
