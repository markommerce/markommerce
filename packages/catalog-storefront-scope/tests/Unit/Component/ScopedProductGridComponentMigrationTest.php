...
it(
    'relocates packages/catalog-scope/src/Component/ScopedProductGridComponent.php to packages/catalog-storefront-scope/src/Component/ScopedProductGridComponent.php with namespace Markommerce\\CatalogStorefrontScope\\Component',
    function (): void {
...
it(
    'relocates the matching test file to packages/catalog-storefront-scope/tests/Unit/Component/ScopedProductGridComponentTest.php with updated imports',
    function (): void {
...
it(
    'updates the PreferenceDiscovery test inside the moved test to construct a ModuleManifest with name=markommerce/catalog-storefront-scope and the corresponding path',
    function (): void {
        $targetPath = __DIR__ . '/ScopedProductGridComponentTest.php';
...
it(
    'removes markommerce/catalog-storefront from packages/catalog-scope/composer.json require (added temporarily in task 002)',
    function (): void {
...
it(
    'asserts catalog-scope\'s composer.json no longer lists markommerce/catalog-storefront in require or require-dev (regression guard)',
    function (): void {
        $composerPath = dirname(__DIR__, 4) . '/catalog-scope/composer.json';
        $composer = json_decode(file_get_contents($composerPath), true);
...
it(
    'asserts no file under packages/catalog-scope references Markommerce\\CatalogStorefront\\ or Markommerce\\CatalogStorefrontScope\\ after the move',
    function (): void {
