...
it('creates packages/catalog-storefront-scope/composer.json declaring markommerce/catalog-storefront-scope as a marko-module with the correct require list', function (): void {
...
it('creates packages/catalog-storefront-scope/LICENSE, .gitattributes, src/Component/, and tests/Pest.php matching the project scaffolding conventions', function (): void {
...
it('adds markommerce/catalog-storefront-scope to the root composer.json require block alphabetically within the markommerce/* group', function (): void {
...
it('adds Markommerce\\CatalogStorefrontScope\\Tests\\ to the root composer.json autoload-dev.psr-4 block', function (): void {
    $rootComposerPath = dirname(__DIR__, 4) . '/composer.json';
    $composer = json_decode(file_get_contents($rootComposerPath), true);
