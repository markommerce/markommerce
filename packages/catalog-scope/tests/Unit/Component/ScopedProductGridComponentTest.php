...
use Markommerce\CatalogScope\Component\ScopedProductGridComponent;
...
it('is resolved by the container as the preferred binding for ProductGridComponent when catalog-scope is installed (verifies #[Preference] discovery)', function (): void {
