...
it('CatalogLocaleSeeder runs after CatalogSeeder, fetches all products/categories, attaches scoped-override companions with German and French translations, and saves them through the catalog repositories', function (): void {
