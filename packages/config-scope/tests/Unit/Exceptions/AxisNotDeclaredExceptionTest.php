...
it('relocates only AxisNotDeclaredException::forPropertyAndAxis() to Markommerce\ConfigScope\Exceptions; the forAxisOnProperty() factory used by the pre-P5 ConfigRegistryBuilder build-time scan is dropped', function (): void {
